...
<div class="container mt-4">
    ...
    <form action="{{ route('questions.store') }}" method="POST">
        ...
        <div class="mb-3">
            ...
            <select id="questionType" name="type" class="form-control @error('type') is-invalid @enderror" required onchange="renderOptions()">
                <option value=""></option>
...
function renderOptions() {
    ...
    if (type === 'true_false') {
        ...
        html += `</div><button type="button" class="btn btn-sm btn-outline-primary" onclick="addFillBlankOption()">➕ Add Another Answer</button>`;
        ...
        html += `</div><button type="button" class="btn btn-sm btn-outline-primary" onclick="addOption()">➕ Add Option</button>`;
        container.innerHTML = html;
    }
}
